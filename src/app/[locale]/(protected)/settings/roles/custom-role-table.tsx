...
import { getRoleBadgeColor, type DBRole } from "./constants";
...
export function CustomRoleTable({ canManage, dbRoles }: CustomRoleTableProps) {
    ...
    const deleteMutation = useMutation({
        ...
        onSuccess: () => {
            toast.success(t("settingsRolesCustomDeleteSuccess"));
        ...
        onError: (err: Error) => {
            toast.error(err.message || t("settingsRolesCustomDeleteError"));
        },
    });
                    ...
                    <AlertDialogFooter>
                        ...
                        >
                            {deleteMutation.isPending
                                ? t("settingsRolesCustomDeleting")
                                : t("settingsRolesCustomDeleteAction")}
                        </AlertDialogAction>
                    </AlertDialogFooter>
                </AlertDialogContent>
            </AlertDialog>
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {(viewRole?.userCount ?? 0) > 0
                                ? t("settingsRolesCustomAssignedUsersPrefix", {
                                      count: viewRole?.userCount ?? 0,
                                  })
                                : ""}
