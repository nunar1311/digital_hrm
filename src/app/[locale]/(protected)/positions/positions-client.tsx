...
const AUTHORITY_OPTIONS = [
  { value: "ALL", labelKey: "positionsAuthorityAll" },
  { value: "EXECUTIVE", labelKey: "positionsAuthorityExecutive" },
  { value: "DIRECTOR", labelKey: "positionsAuthorityDirector" },
  { value: "MANAGER", labelKey: "positionsAuthorityManager" },
  { value: "DEPUTY", labelKey: "positionsAuthorityDeputy" },
  { value: "TEAM_LEAD", labelKey: "positionsAuthorityTeamLead" },
  { value: "STAFF", labelKey: "positionsAuthorityStaff" },
  { value: "INTERN", labelKey: "positionsAuthorityIntern" },
] as const;

const STATUS_OPTIONS = [
  { value: "ALL", labelKey: "positionsStatusAll" },
  { value: "ACTIVE", labelKey: "positionsStatusActive" },
  { value: "INACTIVE", labelKey: "positionsStatusInactive" },
] as const;
...
export default function PositionsClient() {
  ...
  const [deleteTarget, setDeleteTarget] = useState<PositionListItem | null>(
    null,
  );
  ...
  const selectedAuthority = AUTHORITY_OPTIONS.find(
    (option) => option.value === authorityFilter,
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
            ...
            {t("positionsPageTitle")}
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            {t("positionsPageDescription")}
          </p>
        </div>
        <Button
          onClick={() => {
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              {selectedAuthority
                ? t(selectedAuthority.labelKey)
                : t("positionsAuthorityLabel")}
            </Button>
          </DropdownMenuTrigger>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>{t("positionsDeleteConfirmTitle")}</AlertDialogTitle>
            <AlertDialogDescription>
              {t("positionsDeleteConfirmDescription", { name: deleteTarget?.name ?? "" })}
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>{t("positionsCancel")}</AlertDialogCancel>
            <AlertDialogAction
