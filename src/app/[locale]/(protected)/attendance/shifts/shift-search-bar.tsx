    ...
    return (
        <div className="flex items-center gap-2">
            <div className="relative w-full max-w-50">
                ...
                <Input
                    placeholder={t("attendanceShiftsSearchPlaceholder")}
                    value={searchQuery}
                ...
                {searchQuery && (
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p>{t("attendanceShiftsClearSearch")}</p>
                        </TooltipContent>
                    </Tooltip>
                )}
            </div>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        ...
                        >
                            <ListFilter />
                            {departmentIds.length > 0 &&
                                t("attendanceShiftsDepartmentsCount", {
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                        ...
                        >
                            {t("attendanceShiftsAllDepartments")}
                        </DropdownMenuCheckboxItem>
                        {departments.map((d) => (
                            <DropdownMenuCheckboxItem
                                key={d.id}
            ...
            <Tooltip>
                ...
                <TooltipContent side="right">
                    <p>{t("attendanceShiftsRefreshData")}</p>
                </TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
                ...
                <TooltipContent side="right">
                    <p>{t("attendanceShiftsSettings")}</p>
                </TooltipContent>
            </Tooltip>
        </div>
    );
