            ...
            <TableHeader className="bg-background shadow-sm ">
              <TableRow>
                <TableHead className="bg-background min-w-40 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.1)] z-10 border-r">
                  {t("attendanceMonthlyGridHeadEmployee")}
                </TableHead>
                {visibleDays.map((d) => {
                  const date = new Date(year, month - 1, d);
                ...
                <TableHead className="text-center min-w-[50px] bg-background shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)] z-10">
                  {t("attendanceMonthlyGridHeadWorkDays")}
                </TableHead>
                <TableHead className="text-center min-w-[50px] bg-background shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)] z-10">
                  {t("attendanceMonthlyGridHeadLate")}
                </TableHead>
                <TableHead className="text-center min-w-[50px] bg-background shadow-[-2px_0_5px_-2px_rgba(0,0,0,0.1)] z-10">
                  {t("attendanceMonthlyGridHeadAbsent")}
                </TableHead>
              </TableRow>
            </TableHeader>
            ...
            <TableBody>
              ...
              {rows.length === 0 && (
                <TableRow>
                  ...
                  >
                    {isFetching
                      ? t("attendanceMonthlyGridLoading")
                      : t("attendanceMonthlyGridEmpty")}
                  </TableCell>
                </TableRow>
              )}
            </TableBody>
