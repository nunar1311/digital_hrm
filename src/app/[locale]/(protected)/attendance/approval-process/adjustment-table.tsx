    ...
    if (chain.length === 0) {
        return (
            <span className="text-xs text-muted-foreground">
                {t("attendanceApprovalAdjustmentEmpty")}
            </span>
        );
    }
        ...
        <div className="space-y-1">
            ...
            >
                ...
                <span className="text-muted-foreground">
                    {t("attendanceApprovalAdjustmentStepSuffix")}
                </span>
            </button>
...
export function AdjustmentTable({
    ...
    const statusLabelMap: Record<string, string> = {
        PENDING: t("attendanceApprovalAdjustmentStatusPending"),
        APPROVED: t("attendanceApprovalAdjustmentStatusApproved"),
        REJECTED: t("attendanceApprovalAdjustmentStatusRejected"),
        AUTO_APPROVED: t("attendanceApprovalAdjustmentStatusAutoApproved"),
        CANCELLED: t("attendanceApprovalAdjustmentStatusCancelled"),
    };
    ...
    if (requests.length === 0) {
        return (
            <div className="text-center py-12 text-muted-foreground">
                {t("attendanceApprovalAdjustmentEmptyRequests")}
            </div>
        );
    }
        ...
        <div className="relative">
            <div className="rounded-md border">
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderEmployee")}</TableHead>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderDate")}</TableHead>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderAdjustedTime")}</TableHead>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderReason")}</TableHead>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderStatus")}</TableHead>
                            <TableHead>{t("attendanceApprovalAdjustmentHeaderFlow")}</TableHead>
                            <TableHead className="w-[120px]">
                                {t("attendanceApprovalAdjustmentHeaderActions")}
                            </TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {requests.map((request) => (
                            <TableRow key={request.id}>
                                ...
                                <TableCell className="text-sm">
                                    {formatDate(request.date, timezone, locale)}
                                </TableCell>
                                <TableCell className="text-sm">
                                    <div>
                                        <p>
                                            <span className="text-muted-foreground">
                                                {t("attendanceApprovalAdjustmentCheckIn")}: {" "}
                                            </span>
                                            {formatTime(request.checkInTime)}
                                        </p>
                                        <p>
                                            <span className="text-muted-foreground">
                                                {t("attendanceApprovalAdjustmentCheckOut")}: {" "}
                                            </span>
                                            {formatTime(
                                ...
                                <TableCell>
                                    <StatusBadge
                                        ...
                                        label={
                                            ...
                                            t("attendanceApprovalAdjustmentStatusPending")
                                        }
                                    />
                                </TableCell>
                                <TableCell>
                                    ...
                                    <div className="flex items-center gap-1">
                                        {onViewDetail && (
                                            <Button
                                                ...
                                                title={t("attendanceApprovalAdjustmentActionViewDetail")}
                                            >
                                        ...
                                        {actionMode === "own" &&
                                            ...
                                            onCancel && (
                                                <Button
                                                    ...
                                                    title={t("attendanceApprovalAdjustmentActionCancelRequest")}
                                                >
