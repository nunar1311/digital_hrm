...
interface StepCardProps {
    ...
    onMoveUp?: () => void;
    onMoveDown?: () => void;
    /** list: horizontal row mode; flow: card with a colored process-style header */
    displayMode?: StepCardDisplayMode;
    /** Header title in flow mode (e.g., Condition 1) */
    flowHeaderTitle?: string;
    /** Extra badge on header (e.g., Priority 1) */
    flowHeaderBadge?: string;
    /** Extra approver tag (e.g., short approval method) */
...
export function StepCard({
    ...
    const stepTypeLabelMap: Record<string, string> = {
        APPROVER: t("attendanceApprovalStepTypeApprover"),
        CONDITION: t("attendanceApprovalStepTypeCondition"),
    };
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    ...
                    >
                        <span className="sr-only">
                            {t("attendanceApprovalStepCardOpenMenu")}
                        </span>
                        <svg
                            width="15"
                            height="15"
                ...
                <DropdownMenuContent align="end">
                    <DropdownMenuItem onClick={onEdit}>
                        ...
                        {t("attendanceApprovalStepCardEdit")}
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem
                        onClick={onDelete}
                    ...
                    >
                        ...
                        {t("attendanceApprovalStepCardDeleteStep")}
                    </DropdownMenuItem>
                </DropdownMenuContent>
            </DropdownMenu>
        </div>
    ...
    if (displayMode === "flow") {
        const headerTitle =
            flowHeaderTitle ||
            `${t("attendanceApprovalStepCardStepPrefix")} ${step.stepOrder} — ${stepTypeLabelMap[step.stepType]}`;
            ...
            <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                    <span className="text-sm font-medium">
                        {t("attendanceApprovalStepCardStepPrefix")} {step.stepOrder} —{" "}
