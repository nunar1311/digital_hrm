...
function getRelativeTime(
    ...
    try {
        ...
        if (diffMins < 1) return t("attendanceLeaveRequestsRelativeJustNow");
        if (diffMins < 60)
            return t("attendanceLeaveRequestsRelativeMinutesAgo", {
                minutes: diffMins,
            });
        if (diffHours < 24)
            return t("attendanceLeaveRequestsRelativeHoursAgo", {
                hours: diffHours,
            });
        if (diffDays < 7)
            return t("attendanceLeaveRequestsRelativeDaysAgo", {
                days: diffDays,
            });
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    ...
                    {t("attendanceLeaveRequestsFilterButton")}
                    {hasFilters && (
                        <Badge
                            variant="default"
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <p className="font-semibold text-sm">
                            {t("attendanceLeaveRequestsFilterTitle")}
                        </p>
                        {hasFilters && (
                            <Button
                                variant="ghost"
                            ...
                            >
                                {t("attendanceLeaveRequestsReset")}
                            </Button>
                        )}
                    </div>
                    ...
                    <div className="space-y-2">
                        <Label className="text-xs text-muted-foreground">
                            {t("attendanceLeaveRequestsLeaveType")}
                        </Label>
                        <Select
                        ...
                        >
                            <SelectTrigger className="w-full">
                                <SelectValue
                                    placeholder={t(
                                        "attendanceLeaveRequestsLeaveTypePlaceholder"
                                    )}
                                />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="all">
                                    {t("attendanceLeaveRequestsAllTypes")}
                                </SelectItem>
                                {leaveTypes.map((t) => (
                    ...
                    <div className="space-y-2">
                        <Label className="text-xs text-muted-foreground">
                            {t("attendanceLeaveRequestsSortBy")}
                        </Label>
                        <Select value={sortBy} onValueChange={setSortBy}>
                            ...
                            <SelectContent>
                                <SelectItem value="date_desc">
                                    {t("attendanceLeaveRequestsSortNewest")}
                                </SelectItem>
                                <SelectItem value="date_asc">
                                    {t("attendanceLeaveRequestsSortOldest")}
                                </SelectItem>
                                <SelectItem value="name_asc">
                                    {t("attendanceLeaveRequestsSortNameAsc")}
                                </SelectItem>
                                <SelectItem value="name_desc">
                                    {t("attendanceLeaveRequestsSortNameDesc")}
                                </SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
            ...
            <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        {t("attendanceLeaveRequestsDetailTitle")}
                    </DialogTitle>
                    <DialogDescription>
                        {t("attendanceLeaveRequestsRequestCode", {
                ...
                <div className="space-y-5">
                        ...
                        {request.leaveType && (
                            ...
                            >
                                {request.leaveType.isPaidLeave
                                    ? t("attendanceLeaveRequestsPaid")
                                    : t("attendanceLeaveRequestsUnpaid")}
                            </Badge>
                        )}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            <div className="text-xs text-muted-foreground">
                                {t("attendanceLeaveRequestsFromDate")}
                            </div>
                        ...
                        <div className="space-y-1">
                            <div className="text-xs text-muted-foreground">
                                {t("attendanceLeaveRequestsToDate")}
                            </div>
                            <div className="flex items-center gap-2">
                                <Calendar className="h-4 w-4 text-muted-foreground" />
                                <span className="font-medium text-sm">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-muted-foreground">
                                {t("attendanceLeaveRequestsTotalDaysLabel")}
                            </span>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-muted-foreground">
                                {t("attendanceLeaveRequestsSubmittedLabel")}
                            </span>
                            <span>
                                {getRelativeTime(request.createdAt, timezone, t)}
                            </span>
                        </div>
                    </div>
                    ...
                    {request.reason && (
                        <div className="space-y-1">
                            <div className="text-xs text-muted-foreground">
                                {t("attendanceLeaveRequestsReason")}
                            </div>
                    ...
                    {request.documentUrl && (
                        <div className="space-y-1">
                            <div className="text-xs text-muted-foreground">
                                {t("attendanceLeaveRequestsAttachment")}
                            </div>
                            <Button variant="outline" size="sm" asChild>
                                ...
                                >
                                    ...
                                    {t("attendanceLeaveRequestsDownloadAttachment")}
                                </a>
                            </Button>
                        </div>
                    )}
                    ...
                    {request.approvedByUser && (
                        <div className="space-y-1">
                            <div className="text-xs text-muted-foreground">
                                {t("attendanceLeaveRequestsApprover")}
                            </div>
                            <div className="flex items-center gap-2">
                    ...
                    {request.status === "REJECTED" && request.rejectionReason && (
                        <div className="bg-red-50 border border-red-100 rounded-lg p-3 space-y-1">
                            <div className="flex items-center gap-2 text-red-700 font-medium text-sm">
                                ...
                                {t("attendanceLeaveRequestsRejectReason")}
                            </div>
                    ...
                    {showRejectForm && (
                        <div className="space-y-2">
                            <Label className="text-sm">
                                {t("attendanceLeaveRequestsRejectReason")} <span className="text-destructive">*</span>
                            </Label>
                            <Textarea
                                value={rejectReason}
                                onChange={(e) =>
                                ...
                                placeholder={t(
                                    "attendanceLeaveRequestsRejectReasonPlaceholder"
                                )}
                                rows={3}
                            />
                        </div>
                            ...
                            {!showRejectForm ? (
                                <>
                                    ...
                                    >
                                        ...
                                        {t("attendanceLeaveRequestsReject")}
                                    </Button>
                                    <Button
                                        onClick={onApprove}
                                    ...
                                    >
                                        ...
                                        {t("attendanceLeaveRequestsApprove")}
                                    </Button>
                                </>
                            ) : (
                                <>
                                    ...
                                    >
                                        {t("attendanceLeaveRequestsCancel")}
                                    </Button>
                                    <Button
                                        variant="destructive"
                                    ...
                                    >
                                        ...
                                        {t("attendanceLeaveRequestsConfirmReject")}
                                    </Button>
                                </>
                            )}
                        </>
...
export function LeaveRequestsClient({
    ...
    const approveMutation = useMutation({
        ...
        onSuccess: () => {
            toast.success(t("attendanceLeaveRequestsToastApproveSuccess"));
        ...
        onError: (error: Error) => {
            toast.error(error.message || t("attendanceLeaveRequestsToastApproveError"));
        },
    });
    ...
    const rejectMutation = useMutation({
        ...
        onSuccess: () => {
            toast.success(t("attendanceLeaveRequestsToastRejectSuccess"));
            queryClient.invalidateQueries({
                queryKey: ["leave-requests-for-approval"],
            });
            queryClient.invalidateQueries({
        ...
        onError: (error: Error) => {
            toast.error(error.message || t("attendanceLeaveRequestsToastRejectError"));
        },
    });
    ...
    const columns = useMemo<ColumnDef<LeaveRequestItem>[]>(
        () => [
                ...
                header: () => {
                    ...
                    return (
                        <Checkbox
                            ...
                            aria-label={t("attendanceLeaveRequestsSelectAll")}
                        />
                    );
                },
                cell: ({ row }) => (
                    <Checkbox
                        ...
                        aria-label={t("attendanceLeaveRequestsSelectUserRequest", {
                            userName: getUserName(row.original.user),
                        })}
            ...
            },
            {
                ...
                id: "userName",
                header: t("attendanceLeaveRequestsHeadEmployee"),
                size: 200,
                cell: ({ row }) => {
            ...
            },
            {
                ...
                id: "department",
                header: t("attendanceLeaveRequestsHeadDepartment"),
                size: 150,
                cell: ({ row }) => (
                    <Badge
                        variant="secondary"
            ...
            },
            {
                ...
                id: "leaveType",
                header: t("attendanceLeaveRequestsHeadLeaveType"),
                size: 140,
                cell: ({ row }) => (
                    <span className="text-sm">
                        {row.original.leaveType?.name || t("attendanceLeaveRequestsNotAvailable")}
                    </span>
                ),
            },
            {
                id: "dateRange",
                header: t("attendanceLeaveRequestsHeadDateRange"),
                size: 160,
                cell: ({ row }) => (
                    <div className="text-xs text-muted-foreground">
            ...
            },
            {
                ...
                id: "totalDays",
                header: t("attendanceLeaveRequestsHeadDays"),
                size: 60,
                cell: ({ row }) => (
            ...
            },
            {
                accessorKey: "status",
                id: "status",
                header: t("attendanceLeaveRequestsHeadStatus"),
                size: 120,
                cell: ({ row }) => {
            ...
            },
            {
                ...
                id: "createdAt",
                header: t("attendanceLeaveRequestsHeadSubmitted"),
                size: 110,
                cell: ({ row }) => (
                    <span className="text-xs text-muted-foreground">
            ...
            {
                id: "actions",
                header: t("attendanceLeaveRequestsHeadActions"),
                size: 100,
                enableHiding: false,
                cell: ({ row }) => {
                    ...
                    return (
                        <div className="flex items-center gap-1 justify-end">
                            {isPending && (
                                <>
                                    <Button
                                        ...
                                        title={t("attendanceLeaveRequestsApproveOrView")}
                                    >
                            ...
                            <Button
                                ...
                                title={t("attendanceLeaveRequestsViewDetail")}
                            >
        ...
        [tabData, selectedIds, timezone, t]
    );
        ...
        <div className="w-full min-h-0 h-full grow flex flex-col bg-background">
            ...
            <div className="flex flex-col gap-0">
                <section>
                    <header className="p-2 flex items-center h-10 border-b">
                        <h1 className="font-bold flex items-center gap-2">
                            ...
                            {t("attendanceLeaveRequestsTitle")}
                        </h1>
                    </header>
                </section>
                ...
                <div className="grid gap-3 p-2 shrink-0 grid-cols-2 lg:grid-cols-4">
                    <StatCard
                        title={t("attendanceLeaveRequestsStatsPending")}
                        value={statsData.pending}
                        icon={Clock}
                        className="border-yellow-200 bg-yellow-50/50"
                    />
                    <StatCard
                        title={t("attendanceLeaveRequestsStatsApproved")}
                        value={statsData.approved}
                        icon={CheckCircle2}
                        className="border-green-200 bg-green-50/50"
                    />
                    <StatCard
                        title={t("attendanceLeaveRequestsStatsRejected")}
                        value={statsData.rejected}
                        icon={XCircle}
                        className="border-red-200 bg-red-50/50"
                    />
                    <StatCard
                        title={t("attendanceLeaveRequestsStatsTotal")}
                ...
                <div className="flex items-center justify-end gap-1 px-2 py-2 shrink-0">
                        ...
                        <SelectContent>
                            {years.map((y) => (
                                <SelectItem key={y} value={String(y)}>
                                    {t("attendanceLeaveRequestsYearOption", {
                                        year: y,
                                    })}
                                </SelectItem>
                            ))}
                    ...
                    >
                        <Input
                            ...
                            placeholder={t("attendanceLeaveRequestsSearchPlaceholder")}
                            className={cn(
                ...
                <TableSettingsPanel
                    ...
                    columnOptions={[
                        {
                            key: "userName",
                            label: t("attendanceLeaveRequestsHeadEmployee"),
                            icon: User,
                        },
                        {
                            key: "department",
                            label: t("attendanceLeaveRequestsHeadDepartment"),
                            icon: Building2,
                        },
                        {
                            key: "leaveType",
                            label: t("attendanceLeaveRequestsHeadLeaveType"),
                            icon: CalendarDays,
                        },
                        {
                            key: "dateRange",
                            label: t("attendanceLeaveRequestsTableSettingsDateRange"),
                            icon: Calendar,
                        },
                        {
                            key: "totalDays",
                            label: t("attendanceLeaveRequestsHeadDays"),
                            icon: Clock,
                        },
                        {
                            key: "status",
                            label: t("attendanceLeaveRequestsHeadStatus"),
                            icon: FileText,
                        },
                        {
                            key: "createdAt",
                            label: t("attendanceLeaveRequestsTableSettingsSubmittedDate"),
                            icon: Clock,
                        },
                    ]}
                    className="top-10"
            ...
            <div className="flex items-center gap-1 px-2 pb-0 border-b bg-background shrink-0">
                {(
                    [
                        {
                            value: "all",
                            label: t("attendanceLeaveRequestsTabAll"),
                            count: allItems.length,
                        },
                        {
                            value: "pending",
                            label: t("attendanceLeaveRequestsTabPending"),
                            count: pendingItems.length,
                        },
                        {
                            value: "approved",
                            label: t("attendanceLeaveRequestsTabApproved"),
                            count: approvedItems.length,
                        },
                        {
                            value: "rejected",
                            label: t("attendanceLeaveRequestsTabRejected"),
            ...
            {selectedIds.size > 0 && (
                <div className="flex items-center gap-2 px-2 py-1.5 bg-primary/5 border-b border-primary/20 shrink-0">
                    <span className="text-xs text-muted-foreground">
                        {t("attendanceLeaveRequestsSelected")} {" "}
                        <strong className="text-foreground">
                            {selectedIds.size}
                        </strong>{" "}
                        {t("attendanceLeaveRequestsUnitRequest")}
                    </span>
                    <Button
                        variant="default"
                        size="xs"
                    ...
                    >
                        ...
                        {t("attendanceLeaveRequestsApprovePendingBulk", {
                            count: Array.from(selectedIds).filter((id) => {
                                const req = requestsData.items.find(
                                    (r) => r.id === id
                                );
                                return req && req.status === "PENDING";
                            }).length,
                            ...
                            <TableRow>
                                ...
                                >
                                    <div className="flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p>{t("attendanceLeaveRequestsEmpty")}</p>
                                        {search && (
                                            <Button
                                                variant="link"
                                                size="sm"
                                            ...
                                            >
                                                {t("attendanceLeaveRequestsClearSearch")}
                                            </Button>
                                        )}
                                    </div>
                                </TableCell>
            ...
            {!isLoading && requestsData.total > 0 && (
                <div className="shrink-0 px-2 py-2 border-t bg-background flex items-center justify-between">
                    <p className="text-xs text-muted-foreground">
                        {t("attendanceLeaveRequestsShowing", {
                            shown: tabData.length,
                    ...
                    {pendingItems.length > 0 && (
                        ...
                        >
                            {t("attendanceLeaveRequestsPendingForYou", {
                                count: pendingItems.length,
                            })}
                        </Badge>
                    )}
