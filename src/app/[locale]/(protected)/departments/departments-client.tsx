...
const STATUS_OPTIONS: { value: DepartmentStatus; labelKey: string }[] = [
    { value: "ALL", labelKey: "departmentsStatusAll" },
    { value: "ACTIVE", labelKey: "departmentsStatusActive" },
    { value: "INACTIVE", labelKey: "departmentsStatusInactive" },
];
                ...
                <section>
                    ...
                    <div className="flex items-center justify-end gap-2 px-2 py-2">
                        ...
                        >
                            <Input
                                ...
                                placeholder={t("departmentsSearchPlaceholder")}
                                className={cn(
                    ...
                    <TableSettingsPanel
                        ...
                        columnOptions={[
                            {
                                key: "select",
                                label: t("departmentsColSelect"),
                                icon: Checkbox,
                            },
                            {
                                key: "employee",
                                label: t("departmentsColName"),
                                icon: Building2,
                            },
                            { key: "code", label: t("departmentsColCode"), icon: Hash },
                            {
                                key: "manager",
                                label: t("departmentsColManager"),
                                icon: Users,
                            },
                            {
                                key: "employeeCount",
                                label: t("departmentsColEmployeeCount"),
                                icon: Users,
                            },
                            {
                                key: "parent",
                                label: t("departmentsColParent"),
                                icon: ArrowUp,
                            },
                            {
                                key: "status",
                                label: t("departmentsColStatus"),
                                icon: CircleDot,
                            },
                        ]}
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            {t("departmentsDeleteConfirmDescriptionPrefix")}{" "}
                            <strong>{deleteTarget?.name}</strong>{" "}
                            {t("departmentsDeleteConfirmDescriptionSuffix")}
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                        <AlertDialogCancel
