...
import type { InterviewFilters, InterviewResponse, JobPostingResponse } from "@/app/[locale]/(protected)/recruitment/types";
import {
    CalendarHeader,
    CalendarSidebar,
    CalendarGrid,
...
export function RecruitmentCalendarClient({
    ...
    return (
        <div className="p-4 md:p-6 space-y-6">
            <div>
                <h3 className="text-2xl font-bold">Lá»‹ch phá»ng váº¥n</h3>
                <p className="text-sm text-muted-foreground">
                    Quáº£n lÃ½ lá»‹ch phá»ng váº¥n vÃ  á»©ng viÃªn
                </p>
            </div>
