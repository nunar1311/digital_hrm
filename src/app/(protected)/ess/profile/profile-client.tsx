...
export function ESSProfileClient({ initialProfile }: ESSProfileClientProps) {
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      await submitProfileUpdateRequest({ field: editField, value: editValue });
  ...
  return (
    <div className="w-full min-h-0 h-full grow flex flex-col bg-background">
      {/* Header */}
      <div className="shrink-0 border-b bg-linear-to-r from-purple-50/50 to-primary/5 p-2">
      ...
      <div className="flex-1 overflow-auto p-4 md:p-6 space-y-6">
        {/* Profile Header Card */}
        <Card className="bg-linear-to-r from-purple-50/50 to-blue-50/50 border-purple-100">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mt-2">
                  ...
                  {profile.position && (
                    <Badge variant="outline">{profile.position.name}</Badge>
                  )}
                </div>
              ...
              <div className="flex gap-4 text-center">
                <div className="px-4">
                  <div className="text-2xl font-bold text-purple-600">
                    {profile.hireDate
                      ? Math.floor(
                          (Date.now() - new Date(profile.hireDate).getTime()) /
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <InfoCard icon={Mail} title="Thông tin liên hệ">
            ...
            <InfoRow
              ...
              editable
              onEdit={() =>
                handleEditField("personalEmail", profile.personalEmail || "")
              }
            />
            <InfoRow
              label="Số điện thoại"
          ...
          <InfoCard icon={FileText} title="Thông tin ngân hàng & thuế">
            ...
            <InfoRow
              ...
              editable
              onEdit={() =>
                handleEditField("bankAccount", profile.bankAccount || "")
              }
            />
            <InfoRow
              label="Ngân hàng"
          ...
          <InfoCard icon={Phone} title="Liên hệ khẩn cấp">
            ...
            <InfoRow
              ...
              editable
              onEdit={() =>
                handleEditField("emergencyPhone", profile.emergencyPhone || "")
              }
            />
          </InfoCard>
        </div>
