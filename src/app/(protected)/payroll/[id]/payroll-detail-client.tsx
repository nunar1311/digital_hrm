...
import type { PayrollRecord, PayrollRecordDetail, Payslip } from "@/app/(protected)/payroll/types";
...
function getStatusBadge(status: string) {
    switch (status) {
        ...
        case "PROCESSING":
            return <Badge variant="outline" className="border-blue-500 text-blue-600">Đang xử lý</Badge>;
        case "COMPLETED":
...
export default function PayrollDetailClient({
    ...
    const { data: record, isLoading } = useQuery({
        ...
        queryFn: () => getPayrollRecord(recordId),
    ...
    const deleteMutation = useMutation({
        ...
        onError: (error) => {
            toast.error(error instanceof Error ? error.message : "Lỗi khi xóa bảng lương");
    ...
    const filteredPayslips = payslips?.filter((p) => p.payrollRecordId === recordId) || [];
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-6">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        ...
                        <CardTitle className="text-xl">{formatCurrency(record.totalGross)}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                        <CardDescription>Tổng lương Net</CardDescription>
                        <CardTitle className="text-xl text-green-600">{formatCurrency(record.totalNet)}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                        <CardDescription>Tổng thuế TNCN</CardDescription>
                        <CardTitle className="text-xl text-red-600">{formatCurrency(record.totalTax)}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                        <CardDescription>Tổng BH</CardDescription>
                        <CardTitle className="text-xl">{formatCurrency(record.totalInsurance)}</CardTitle>
                    </CardHeader>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
                        <CardDescription>Tổng khấu trừ</CardDescription>
                        <CardTitle className="text-xl">{formatCurrency(record.totalDeductions)}</CardTitle>
                    </CardHeader>
                </Card>
            </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList>
                    ...
                    <TabsTrigger value="payslips">Phiếu lương ({filteredPayslips.length})</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="overview" className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="text-base">Thông tin bảng lương</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-medium">{record.department?.name || "Toàn công ty"}</p>
                                    </div>
                                    <div>
                                        <p className="text-muted-foreground">Trạng thái</p>
                                        <p className="font-medium">{getStatusBadge(record.status)}</p>
                                    </div>
                                    <div>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                                        <span className="text-sm font-medium text-green-800">Tổng thu nhập</span>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-between text-sm">
                                            <span className="text-muted-foreground">Tổng thuế TNCN</span>
                                    ...
                                    <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                                        <span className="text-sm font-medium text-blue-800">Thực lĩnh (Net)</span>
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <div className="space-y-1 text-sm">
                                                <div className="flex justify-between">
                                                    <span className="text-muted-foreground">Lương Net:</span>
            ...
            <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Bạn có chắc chắn muốn xóa bảng lương tháng {record.month}/{record.year}? Hành
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            ...
                            {record.totalEmployees} nhân viên. Sau khi duyệt, hệ thống sẽ tạo phiếu
                    ...
                    <div className="space-y-4 py-4">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                            <div className="p-3 bg-muted rounded-lg">
                                ...
                                <p className="text-lg font-semibold">{formatCurrency(record.totalGross)}</p>
                            </div>
                            <div className="p-3 bg-muted rounded-lg">
                ...
                <DialogContent>
                    ...
                    <div className="space-y-4 py-4">
                        <div className="p-4 bg-muted rounded-lg">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Email sẽ chứa thông tin lương và hướng dẫn xem phiếu lương chi tiết
                                trên hệ thống. Tính năng bảo mật sẽ được áp dụng.
                            </p>
                        </div>
