...
function renderApproverChain(
    ...
    > & { keysPrefix: string; stepsLength: number },
) {
    const {
        canEdit,
        getStepSummary,
                            ...
                            {branches.map((branch, bi) => (
                                ...
                                >
                                    <StepCard
                                        ...
                                        displayMode="flow"
                                        flowHeaderTitle={`Điều kiện ${conditionOrdinal(bi)}`}
                                        flowHeaderBadge={
                                            ...
                                            "OTHER"
                                                ...
                                                : branch.condition.priority !=
                                                    null
                                                  ? `Độ ưu tiên ${branch.condition.priority}`
                                                  : undefined
                                        }
                                    />
                                    ...
                                    {canEdit && (
                                        <BranchInsertApproverButton
                                            title="Thêm người duyệt trên nhánh"
                                            disabled={false}
                                            onClick={() =>
                                                onInsertAt(
                ...
                {!showParallelBranches &&
                    ...
                    steps.length === 0 && (
                        <p className="text-sm text-muted-foreground py-6 text-center">
                            Chưa có bước nào. Dùng các nút bên dưới để thêm bước.
                        </p>
                    )}

                <FlowConnector tall />
                <StartEndCapsule label="Kết thúc" />
            </div>
        </div>
    );
}
