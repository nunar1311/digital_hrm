    ...
    <div className="space-y-6 p-4 md:p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Cấu hình quy định chấm công, ngày nghỉ lễ và thiết bị
        </p>
      </div>
      ...
      >
        <TabsList variant={"line"} className="w-60">
          ...
          <TabsTrigger value="holidays" className={TAB_TRIGGER_CLASS}>
            ...
            <span className="hidden sm:inline">Ngày nghỉ lễ</span>
          ...
          <TabsTrigger value="workCycles" className={TAB_TRIGGER_CLASS}>
            ...
            <span className="hidden sm:inline">Chu kỳ làm việc</span>
