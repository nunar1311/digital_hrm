...
export function ShiftNavigation({
  ...
  return (
    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between ">
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button variant="outline" size="icon-xs" onClick={goPrev}>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button variant="outline" size="icon-xs" onClick={goNext}>
      ...
      <span className="ml-1 min-w-50 text-sm font-semibold">{rangeLabel}</span>
    </div>
  );
}
