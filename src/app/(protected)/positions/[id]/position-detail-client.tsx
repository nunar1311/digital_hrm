...
import type { PositionDetail } from "../actions";
                        ...
                        <CardContent>
                            {position.users.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-8 text-muted-foreground">
                                    ...
                                    <p className="text-sm">Chưa có nhân viên nào giữ chức vụ này</p>
                                </div>
                            ) : (
                                ...
                                <div className="space-y-2">
                                    {position.children.map((child) => (
                                        ...
                                        >
                                            ...
                                            >
                                                {AUTHORITY_LABELS[child.authority]?.label || child.authority}
                                            </Badge>
                                        </Link>
                                    ))}
                                </div>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <strong>{position.name}</strong> không? Hành động này sẽ
