import { getRecruitmentStats, getJobPostings, getCandidates, getInterviews } from "../actions";
import { RecruitmentReportsClient } from "./reports-client";

export default async function RecruitmentReportsPage() {
    const [statsData, jobPostingsData, candidatesData, interviewsData] = await Promise.all([
        getRecruitmentStats(),
