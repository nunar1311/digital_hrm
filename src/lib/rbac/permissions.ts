...
export enum Permission {
    ...
    ATTENDANCE_APPROVAL_CONFIG = "attendance:approval_config",
    ATTENDANCE_APPROVAL_VIEW = "attendance:approval_view",
    ATTENDANCE_APPROVAL_APPROVE = "attendance:approval_approve",
    ATTENDANCE_ADJUSTMENT_CREATE = "attendance:adjustment_create",
    ATTENDANCE_ADJUSTMENT_EDIT = "attendance:adjustment_edit",
