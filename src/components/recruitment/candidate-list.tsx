  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Select
          ...
          onValueChange={(v) =>
            setFilters((f) => ({
              ...f,
              stage: (v === "__all__" ? "" : v) as CandidateFilters["stage"],
            }))
          }
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="APPLIED">Ứng tuyển</SelectItem>
        ...
        <Select
          ...
          onValueChange={(v) =>
            setFilters((f) => ({
              ...f,
              source: (v === "__all__" ? "" : v) as CandidateFilters["source"],
            }))
          }
        >
          <SelectTrigger className="w-[150px]">
      ...
      <div className="border rounded-md">
                ...
                candidatesData?.items.map((candidate) => (
                  <TableRow key={candidate.id}>
                    ...
                    <TableCell>
                      <Badge
                        className={
                          STAGE_LABELS[candidate.stage as CandidateStage]?.color
                        }
                      >
                        {STAGE_LABELS[candidate.stage as CandidateStage]?.label}
                      </Badge>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem
                            onClick={() =>
                              setEditingCandidate(candidate as CandidateBasic)
                            }
                          >
                            Chỉnh sửa
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() =>
                              handleStageChange(candidate.id, "SCREENING")
                            }
                          >
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              handleStageChange(candidate.id, "INTERVIEW")
                            }
                          >
                          ...
                          <DropdownMenuItem
                            onClick={() =>
                              handleStageChange(candidate.id, "OFFER")
                            }
                          >
                            Chuyển sang Offer
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() =>
                              handleStageChange(candidate.id, "HIRED")
                            }
                          >
                            Tuyển dụng
                          </DropdownMenuItem>
                          <DropdownMenuItem
                            onClick={() =>
                              handleStageChange(candidate.id, "REJECTED")
                            }
                          >
                            Từ chối
                          </DropdownMenuItem>
        ...
        {/* Footer */}
        {candidatesData && candidatesData.total > 0 && (
          <div className="border-t px-3 py-2 flex items-center justify-between">
            <p className="text-xs text-muted-foreground">
              Hiển thị <strong>{candidatesData.items.length}</strong> /{" "}
              <strong>{candidatesData.total}</strong> ứng viên
            </p>
          </div>
        )}
      </div>
