...
import { TrendingUp, Calendar, Clock, CheckCircle, AlertTriangle, XCircle, Minus } from "lucide-react";
    ...
    return (
        <Card className="gap-2">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 p-4 border border-green-100 dark:border-green-900">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center gap-2 rounded-md bg-green-50 dark:bg-green-950/30 p-2">
                        ...
                        <div>
                            <p className="text-xs text-green-700 dark:text-green-400">Đúng giờ</p>
                    ...
                    <div className="flex items-center gap-2 rounded-md bg-yellow-50 dark:bg-yellow-950/30 p-2">
                        ...
                        <div>
                            <p className="text-xs text-yellow-700 dark:text-yellow-400">Đi muộn</p>
                    ...
                    <div className="flex items-center gap-2 rounded-md bg-orange-50 dark:bg-orange-950/30 p-2">
                        ...
                        <div>
                            <p className="text-xs text-orange-700 dark:text-orange-400">Về sớm</p>
