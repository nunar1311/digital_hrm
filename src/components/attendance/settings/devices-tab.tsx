...
export function DevicesTab({ devices, queryClient }: Props) {
  ...
  const [editDevice, setEditDevice] = useState<TimekeeperDevice | null>(null);
    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>
            Quản lý máy chấm công vân tay, nhận diện khuôn mặt, thẻ từ
          </CardDescription>
        </div>
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {editDevice ? "Chỉnh sửa thiết bị" : "Thêm thiết bị"}
            </DialogTitle>
          </DialogHeader>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="VD: Sảnh tầng 1" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Thiết bị sẽ bị xoá khỏi hệ thống. Dữ liệu chấm công liên quan sẽ
              không bị ảnh hưởng.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
