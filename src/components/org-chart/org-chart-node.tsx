    ...
    >
      ...
      <div className={cn(
            ...
            {(() => {
              const DeptIcon =
                node.logo && DEPARTMENT_ICONS[node.logo]
                  ...
                  : Building2;
              return <DeptIcon className={cn("text-primary", isMobile ? "h-3.5 w-3.5" : "h-4 w-4")} />;
            })()}
          </div>
        ...
        <div className="flex items-center gap-2 mb-2 sm:mb-3 p-1.5 sm:p-2 rounded-lg bg-muted/60">
          <Avatar className={cn("border-2 border-background", isMobile ? "h-7 w-7" : "h-8 w-8")}>
          ...
          <div className="min-w-0 flex-1">
            <p className={cn("font-semibold truncate", isMobile ? "text-[11px]" : "text-xs")}>
              {node.manager ? (
            ...
            <p className={cn("text-muted-foreground truncate", isMobile ? "text-[9px]" : "text-[10px]")}>
              ...
              .map((emp) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "flex items-center w-full gap-1 bg-muted/80 hover:bg-muted rounded-full pl-1 pr-2 py-0.5 text-[10px] cursor-grab active:cursor-grabbing transition-colors group/emp hover:scale-105 hover:shadow-md",
      ...
      {hasChildren && (
        ...
        >
          <div className={cn("flex items-center justify-center gap-1", isMobile ? "size-7" : "size-6")}>
            {isExpanded ? (
          ...
          {hasChildren && !isExpanded && (
            <span className={cn(
              ...
              isMobile ? "px-1.5 py-0.5 text-[10px]" : "px-1.5 py-0.5 text-xs",
            )}>
