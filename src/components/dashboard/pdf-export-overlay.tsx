  ...
  return (
    <Dialog open={isOpen}>
      <DialogContent
        ...
        className="flex flex-row items-center gap-4 p-2 py-2 rounded-full border-0 shadow-lg max-w-[calc(100%-2rem)] w-auto backdrop-blur-md data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95"
      >
