...
const createPayrollSchema = z.object({
    ...
    standardWorkDays: z.number().min(1).max(31).default(22),
});
...
export function CreatePayrollDialog({
    ...
    const createMutation = useMutation({
        ...
        onSuccess: (result) => {
            toast.success(
                `Đã tạo bảng lương tháng ${result.month}/${result.year}`
            );
            setOpen(false);
    ...
    const onSubmit = (data: CreatePayrollForm) => {
        createMutation.mutate({
            ...
            departmentId:
                data.departmentId === "all" ? undefined : data.departmentId,
        });
    };
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Tính lương cho nhân viên trong tháng. Hệ thống sẽ tự
                        động tính toán các khoản BHXH, BHYT, BHTN và thuế TNCN.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    >
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>
                                        Số ngày công chuẩn (mặc định: 22)
                                    </FormLabel>
                                    <FormControl>
                                        <Input
                                            type="number"
                            ...
                            <div className="rounded-lg border bg-muted/50 p-4 space-y-3">
                                ...
                                {previewData.employeeCount === 0 && (
                                    <div className="flex items-center gap-2 text-amber-600 text-sm">
                                        ...
                                        Không có nhân viên nào trong phạm vi
                                        này
                                    </div>
                                )}
                            </div>
