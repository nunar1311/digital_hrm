...
import { ExpandedStateContext } from "./department-sidebar";
...
function hasMatchingDescendant(node: DepartmentNode, query: string): boolean {
...
const DepartmentTree = ({
  ...
  const effectiveOpen = isControlled ? expandedState === "all" : localOpen;
