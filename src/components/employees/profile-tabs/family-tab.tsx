          ...
          {dependents.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {dependents.map((dep) => (
                <div
                  key={dep.id}
                  className="group p-4 rounded-xl border bg-gradient-to-r from-muted/30 to-transparent hover:shadow-md transition-all duration-200"
                >
          ...
          {emergencyContacts.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {emergencyContacts.map((contact) => (
                <div
                  key={contact.id}
                  className="group p-4 rounded-xl border bg-gradient-to-r from-orange-50/20 to-transparent dark:from-orange-950/10 hover:shadow-md transition-all duration-200"
                >
                  <div className="flex items-start gap-3">
